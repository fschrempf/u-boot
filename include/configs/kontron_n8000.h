 ...
 *
 * Configuration settings for the Kontron i.MX8MM boards/SoMs.
 */
#ifndef __KONTRON_N8000_CONFIG_H
#define __KONTRON_N8000_CONFIG_H
...
#define KONTRON_ENV_FDT_FILE		"imx8mm-n8000.dtb"
