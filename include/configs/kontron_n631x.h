 ...
 */
#ifndef __KONTRON_N631X_CONFIG_H
#define __KONTRON_N631X_CONFIG_H

/* Board and environment settings */
#define CONFIG_MXC_UART_BASE		UART4_BASE
#define CONFIG_HOSTNAME			"kontron-n631x"

#define KONTRON_ENV_CONSOLE_DEV		""
#define KONTRON_ENV_KERNEL_MTDPARTS	"mtdparts=spi1.0:128k(spl),832k(u-boot),64k(env);spi4.0:192m(rootfs),-(user)"
#define KONTRON_ENV_FDT_FILE		"imx6ul-n6310-s.dtb"
...
#endif /* __KONTRON_N631X_CONFIG_H */
